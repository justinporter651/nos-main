...
!(function (t) {
  ...
  function (t, e, n) {
    ...
    (i.resize = E(u, _)),
      ...
      (i.ready = function () {
        (h = !0), v ? ((v = !1), d.each(r, p)) : d.each(o, L), d.each(a, L), i.resize.up();
      }),
      (i.load = function (t) {
        k.then(t);
      }),
  ...
  function (t, e, n) {
    ...
    window.tram = (function (t) {
      ...
      var l = (function (t, e, n) {
        ...
        z = function (t) {
          ...
          for (e = 0; e < O.length; e++)
            if ((n = O[e] + i) in T.style) return { dom: n, css: S[e] + t };
        },
        R = (e.support = {
      ...
      if (R.transition) {
        var M = R.timing.dom;
        if (((T.style[M] = d["ease-in-back"][0]), !T.style[M])) for (var C in f) d[C][0] = f[C];
      }
        ...
        $ = l(function (e) {
          ...
          function s(t) {
            ...
            this.timer && this.timer.destroy(),
              ...
              "string" == typeof t
                ? ((e = {})[t] = 1)
                : (e = "object" == (0, i.default)(t) && null != t ? t : this.props),
              h.call(this, e, v),
              f.call(this);
          }
          function l() {
          ...
          function f() {
            ...
            (n = n.join(",")),
              this.style !== n && ((this.style = n), (this.el.style[R.transition.dom] = n));
          }
          function h(t, e, i) {
            var o,
              a,
          ...
          (e.init = function (e) {
            ...
            R.backface && X.hideBackface && U(this.el, R.backface.css, "hidden");
          }),
            g("add", r),
            g("start", o),
            g("wait", function (t) {
        ...
        D = l(function (e) {
          function n() {
            var t,
              ...
              i,
              r = u.length;
            if (r) for (I(n), e = N(), t = r; t--; ) (i = u[t]) && i.render(e);
          }
      ...
      R.transform &&
        ...
        R.transform &&
          R.backface &&
          ((Z.z = [x, "translateZ"]), (Z.rotateZ = [k]), (Z.scaleZ = [b]), (Z.perspective = [y]));
      var Q = /ms/,
        V = /s|\./;
      return (t.tram = e);
    })(window.jQuery);
    ...
    i.define(
      ...
      (t.exports = function (t) {
        ...
        function w(e) {
          ...
          if (
            !(i.env("design") || (window.$.mobile && /(?:^|\s)ui-link(?:$|\s)/.test(a.className)))
          ) {
            var c,
              d =
                ((c = a),
                v.test(c.hash) && c.host + c.pathname === n.host + n.pathname ? a.hash : "");
            if ("" !== d) {
              var f = t(d);
              f.length &&
      ...
      (t.exports = function (t) {
        ...
        function i(e) {
          ...
          function u(t) {
            var e = t.touches;
            (e && e.length > 1) ||
              ((o = !0), e ? ((a = !0), (i = e[0].clientX)) : (i = t.clientX), (r = i));
          }
          function c(e) {
            if (o) {
      ...
      (t.exports = function (t, e) {
        ...
        function k(e, n) {
          ...
          r.el.off(h),
            ...
            _(r),
            s
              ? (r.el.on("setting" + h, R(r)), z(r), (r.hasTimer = !1))
              : (r.el.on("swipe" + h, R(r)),
                r.left.on("click" + h, T(r)),
                r.right.on("click" + h, O(r)),
                r.left.on("keydown" + h, A(r, T)),
                r.right.on("keydown" + h, A(r, O)),
                r.nav.on("keydown" + h, "> div", R(r)),
                r.config.autoplay && !r.hasTimer && ((r.hasTimer = !0), (r.timerCount = 1), S(r)),
                r.el.on("mouseenter" + h, L(r, !0, "mouse")),
                r.el.on("focusin" + h, L(r, !0, "keyboard")),
                r.el.on("mouseleave" + h, L(r, !1, "mouse")),
                r.el.on("focusout" + h, L(r, !1, "keyboard"))),
          ...
          c.addClass(m), b || I(e, n), a.removeClass(m), c.removeClass(m);
        }
        function _(t) {
          var e = { crossOver: 0 };
        ...
        function L(e, n, i) {
          return function (r) {
            ...
            n
              ? (e.ariaLiveLabel.attr("aria-live", "polite"), e.hasTimer && z(e))
        ...
        function R(n) {
          return function (r, a) {
            ...
            if (s && "setting" === r.type) {
              ...
              if ((_(n), N(n), null == a.select)) return;
              !(function (n, i) {
                var r = null;
                i === n.slides.length && (g(), N(n)),
                  e.each(n.anchors, function (e, n) {
                    t(e.els).each(function (e, o) {
                      t(o).index() === i && (r = n);
                    });
                  }),
                  null != r && C(n, { index: r, immediate: !0 });
              })(n, a.select);
            } else {
              if ("swipe" === r.type) {
                if (u.disableSwipe) return;
                if (i.env("editor")) return;
                return "left" === a.direction ? O(n)() : "right" === a.direction ? T(n)() : void 0;
              }
              if (n.nav.has(r.target).length) {
                var c = t(r.target).index();
                if (("click" === r.type && C(n, { index: c }), "keydown" === r.type))
                  switch (r.keyCode) {
                    case o.ENTER:
                    case o.SPACE:
                      C(n, { index: c }), r.preventDefault();
                      break;
                    case o.ARROW_LEFT:
                    case o.ARROW_UP:
        ...
        function C(e, n) {
          ...
          if (
            ...
            return l(v).set(h), void T();
          if (e.index !== e.previous) {
            if (
              (s || e.ariaLiveLabel.text("Slide ".concat(o + 1, " of ").concat(r.length, ".")),
              "cross" === g)
            ) {
              ...
              return (
                (_ = "opacity " + L + "ms " + y),
                l(p).set({ visibility: "" }).add(_).start({ opacity: 0 }),
                void l(v)
            ...
            if ("over" === g)
              return (
                ...
                l(p).set({ visibility: "" }).stop(),
                void l(v)
                  .set({ visibility: "", zIndex: e.depth++, x: f + r[e.index].width * k })
                  .add(E)
                  .start({ x: f })
                  .then(T)
              );
            i.infinite && u.x
              ? (l(e.slides.not(p)).set({ visibility: "", x: u.x }).add(E).start({ x: f }),
                l(p).set({ visibility: "", x: u.from }).add(E).start({ x: u.to }),
                (e.shifted = p))
              : (i.infinite &&
                  e.shifted &&
                  (l(e.shifted).set({ visibility: "", x: d }), (e.shifted = null)),
                l(e.slides).set({ visibility: "" }).add(E).start({ x: f }));
          }
          function T() {
            (v = t(r[e.index].els)),
              (m = e.slides.not(v)),
              "slide" !== g && (h.visibility = "hidden"),
              l(m).set(h);
          }
        }
        function I(e, n) {
