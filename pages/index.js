    ...
    <main>
      ...
      <div className='whosection wf-section'>
        ...
        <p className='who'>
          ...
          actually!) Years ago, a guy by the name of JD McDuffy would pick up my brother Gavin and I
          from school to work out at a local gym. In addition to teaching us the importance of
          physical training, he showed us what a real relationship with Christ looked like. That was
          the start of a mutual dream for Gavin and I to open a gym together. The impact physical
          training had on my life as a kid and young adult made me love the gym experience.
          <br />
        </p>
        <p className='who'>
          I&#x27;ve found that pouring into kids in the same way – teaching them to be committed
          both physically and in life - is my dream. Why does this matter? It&#x27;s not a burden to
          me to work as hard as possible to make sure each client is effectively doing all they
          possibly can to both set goals and meet them successfully. Because of this, I strive to be
          the best at what I do as demonstrated by completing a graduate degree in exercise
          physiology, working late nights with those who need it, weekend continuing ed conferences,
          and researching current medical studies.
        </p>
        <p className='who'>
          My passion is training. I want to help each person – from adolescents to seniors – school
          athletes to adult athletes – achieve their physical and life goals. With that being said,
          Gavin(my brother) would love to introduce himself.
        </p>
        <p className='who'>
          ...
          this gym to allow it to happen. From being funded by a gentleman we had known for just a
          few months - to the step-by-step oddities that have led to what and where No Off Season is
          today. The Lord has allowed us to do what we enjoy doing: train all ages for great things
          in life and see their lives grow before our eyes. Note: We understand that this mission
          goes deeper than most gyms, yet - we love deep. It’s what we know.
        </p>
        <p className='who'>
          This might not be the gym for you if you just want a simple workout that will check all
          the metaphorical "boxes", or if you will have more peace of mind going to a cheaper
          trainer. (There’s nothing wrong with cheap; there&#x27;s always too much to buy and not
          enough to spend, and we know how stressful bills are!) <strong></strong>
        </p>
        <p className='who'>
          <strong>
